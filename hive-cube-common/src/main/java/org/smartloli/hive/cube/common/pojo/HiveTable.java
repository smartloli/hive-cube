...
public class HiveTable {
	...
	public String getTableColumnsZh() {
		return tableColumnsZh;
	}

	public void setTableColumnsZh(String tableColumnsZh) {
		this.tableColumnsZh = tableColumnsZh;
	}
