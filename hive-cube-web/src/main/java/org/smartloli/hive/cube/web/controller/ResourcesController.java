...
import org.smartloli.hive.cube.web.service.ResourceService;
...
/**
 * Resources control and viewer data.
 * 
 * @author smartloli.
 *
...
public class ResourcesController {
	...
	/** Get resource parent data. */
	@RequestMapping(value = "/resource/parent/ajax", method = RequestMethod.GET)
	public void getResParentAjax(HttpServletResponse response, HttpServletRequest request) {
		try {
	...
	/** Get resource children by parent id. */
	@RequestMapping(value = "/resource/child/{parentId}/ajax", method = RequestMethod.GET)
	public void getResChildAjax(@PathVariable("parentId") int parentId, HttpServletResponse response, HttpServletRequest request) {
		try {
