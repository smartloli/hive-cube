			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">
						All Applications <small>overview</small>
					</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="col-lg-12">
					<div class="alert alert-info alert-dismissable">
						...
						<i class="fa fa-info-circle"></i> <strong>Show the list
							of tasks for yarn.</strong> Can be performed on the job to stop.
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-tasks fa-fw"></i> All Jobs Info
...
<jsp:include page="../public/script.jsp">
	<jsp:param value="main/applications/all.js" name="loader" />
</jsp:include>
