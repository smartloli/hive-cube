			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">
						Private Task <small>overview</small>
					</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="col-lg-12">
					<div class="alert alert-info alert-dismissable">
						...
						<i class="fa fa-info-circle"></i> <strong>Show all
							current submitted tasks, edit, execute, and so on.</strong>
					</div>
				</div>
			</div>
			<!-- /.row -->
...
<jsp:include page="../public/script.jsp">
	...
	<jsp:param value="main/tasks/private.js" name="loader" />
</jsp:include>
