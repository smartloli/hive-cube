...
<body>
	...
	<div id="wrapper">
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">
						<spring:message code="tasks.auto.public.content"></spring:message>
						<small><spring:message
								code="tasks.auto.private.content.small"></spring:message></small>
					</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="col-lg-12">
					<div class="alert alert-info alert-dismissable">
						...
						<i class="fa fa-info-circle"></i> <strong><spring:message
								code="tasks.auto.public.head.describer"></spring:message></strong>
					</div>
				</div>
			</div>
			<!-- /.row -->
			...
			<div class="modal fade" aria-labelledby="mfModalLabel"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form" action="/mf/tasks/auto/quartz/modify/"
							method="post"
							...
							<fieldset class="form-horizontal">
								...
								<div class="form-group">
									<div id="mf_quartz_describer" style="left: 40px"
			...
			<!-- stop -->
			<div class="modal fade" aria-labelledby="mfModalLabel"
				aria-hidden="true" id="mf_task_auto_stop_dialog" tabindex="-1"
				role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<!-- /.row -->
						<form role="form" action="/mf/tasks/auto/quartz/stop/"
							method="post">
							<fieldset class="form-horizontal">
								<div class="form-group">
									<div style="left: 40px"
										...
										<button type="button" class="close" data-dismiss="alert"
											aria-hidden="true">×</button>
										<i class="fa fa-info-circle"></i> <strong>是否停止该定时任务?</strong>
									</div>
								</div>
							</fieldset>
							<div class="modal-footer">
			...
			<!-- delete -->
			<div class="modal fade" aria-labelledby="mfModalLabel"
				aria-hidden="true" id="mf_task_auto_delete_dialog" tabindex="-1"
				role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<!-- /.row -->
						<form role="form" action="/mf/tasks/auto/quartz/delete/"
							method="post">
							<fieldset class="form-horizontal">
								<div class="form-group">
									<div style="left: 40px"
										...
										<button type="button" class="close" data-dismiss="alert"
											aria-hidden="true">×</button>
										<i class="fa fa-info-circle"></i> <strong>是否删除该定时任务?</strong>
									</div>
								</div>
							</fieldset>
							<div class="modal-footer">
...
<jsp:include page="../public/script.jsp">
	...
	<jsp:param value="main/tasks/auto.public.js" name="loader" />
</jsp:include>
