$(document).ready(function() {
	$("#result").dataTable({
		...
		"sAjaxSource" : "/hc/tasks/auto/public/table/ajax",
		"aoColumns" : [ {
			"mData" : 'id'
		}, {
			"mData" : 'name'
	...
	$(document).on('click', 'a[name=operater_modal_setting]', function() {
		...
		if (tag == "delete") {
			...
			$('#hc_quartz_describer').find("span").html("<strong>Are you sure you want to cancle the quartz task?</strong>");
		}
